      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="space-y-3 min-w-0">
          <p className="text-xs text-slate-400 leading-snug">
            The scenario is loaded live. Use the controls below to try the fixes yourself and watch
            the waveforms respond — then head to <span className="text-sky-300">Challenges</span> to
            be tested.
          </p>
          <ControlPanel />
          <PatientPanel />
