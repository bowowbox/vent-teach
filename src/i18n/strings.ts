...
const en = {
  ...
  session: {
    ...
    scenarioTitle: 'Load a case',
    normalCase: 'Normal',
    alsoSetVent: 'Also set the learner’s ventilator',
    scenarioHint:
      'Loads the patient in one click. With the ventilator switch off, the learner’s settings are left alone — but auto-triggering, delayed cycling and flow starvation will not appear, because they depend on those settings.',
    instructorHint:
  ...
  feedback: {
    ...
    intro:
      'Found a mistake, a confusing explanation, or something that should work differently? Tell me — it goes straight to the author.',
    messageLabel: 'What would you like to tell me?',
    messagePlaceholder: 'A typo, a clinical inaccuracy, an idea for a lesson…',
    emailLabel: 'Your email (optional, if you would like a reply)',
    contextNote:
      'The tab you are on and your browser version are sent too, so a problem can be reproduced. Nothing else is collected.',
    send: 'Send',
    sending: 'Sending…',
    cancel: 'Cancel',
    close: 'Close',
    thanks: 'Thank you — this has been sent.',
    error: 'Could not send. Check your connection and try again; your message is still here.',
  },
  refs: {
  ...
  about: {
    ...
    // Name and post-nominals stay Latin in both languages, per the convention above.
    byline: 'By Jutamas Saoraya, MD, MScCH(HPTE), PhD',
    siteLabel: 'More about the author',
...
const th: UIStrings = {
  ...
  session: {
    ...
    scenarioTitle: 'โหลดสถานการณ์',
    normalCase: 'ปกติ',
    alsoSetVent: 'ตั้งค่า ventilator ของผู้เรียนด้วย',
    scenarioHint:
      'โหลดผู้ป่วยได้ในคลิกเดียว ถ้าปิดสวิตช์ ventilator ค่าที่ผู้เรียนตั้งไว้จะไม่ถูกเปลี่ยน แต่ auto-triggering, delayed cycling และ flow starvation จะไม่ปรากฏ เพราะทั้งสามอย่างขึ้นกับการตั้งค่าเหล่านั้น',
    instructorHint:
  ...
  feedback: {
    button: 'ข้อเสนอแนะ',
    title: 'ข้อเสนอแนะและคำแนะนำ',
    intro:
      'พบข้อผิดพลาด คำอธิบายที่สับสน หรือมีสิ่งที่ควรทำงานต่างไปจากนี้? บอกได้เลย ข้อความจะส่งถึงผู้จัดทำโดยตรง',
    messageLabel: 'คุณอยากบอกอะไร',
    messagePlaceholder: 'คำผิด ข้อมูลทางคลินิกที่คลาดเคลื่อน หรือไอเดียสำหรับบทเรียน…',
    emailLabel: 'อีเมลของคุณ (ไม่บังคับ กรอกหากต้องการให้ตอบกลับ)',
    contextNote:
      'ระบบจะส่งชื่อแท็บที่คุณกำลังใช้และเวอร์ชันเบราว์เซอร์ไปด้วย เพื่อให้ตรวจสอบปัญหาซ้ำได้ ไม่มีการเก็บข้อมูลอื่น',
    send: 'ส่ง',
    sending: 'กำลังส่ง…',
    cancel: 'ยกเลิก',
    close: 'ปิด',
    thanks: 'ขอบคุณ ส่งข้อความเรียบร้อยแล้ว',
    error: 'ส่งไม่สำเร็จ กรุณาตรวจสอบการเชื่อมต่อแล้วลองอีกครั้ง ข้อความของคุณยังอยู่',
  },
  refs: {
  ...
  about: {
    ...
    byline: 'โดย Jutamas Saoraya, MD, MScCH(HPTE), PhD',
    siteLabel: 'ดูข้อมูลเกี่ยวกับผู้จัดทำ',
